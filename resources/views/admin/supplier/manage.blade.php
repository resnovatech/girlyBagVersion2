                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="page-title-box">
                                <h4 class="font-size-18">Supplier</h4>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Resnova</a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Vendor & CRM
</a></li>
                                      ...
                                      @endif
                                                ...
                                                <td>
                                                    ...
                                                    @if (Auth::guard('admin')->user()->can('supplier.edit'))
                                                        <a type="button" href="{{ route('admin.supplier.edit', $category->id) }}" class="btn btn-primary waves-light waves-effect"><i class="fas fa-pencil-alt"></i></a>
                                                        @endif
...
@endif
                                                        <form id="delete-form-{{ $category->id }}" action="{{ route('admin.supplier.destroy',$category->id) }}" method="POST" style="display: none;">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title mt-0" id="myLargeModalLabel">Add New Supplier</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>
                        <div class="modal-body">
                            <form class="custom-validation" action="{{ route('admin.supplier.store') }}" method="post">
                            @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
