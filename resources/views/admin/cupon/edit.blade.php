...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="page-title-box">
                    <h4 class="font-size-18">Update Cupon</h4>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active">Update Cupon</li>
                    </ol>
                </div>
            </div>
        ...
        <!-- end page title -->
        <form action="{{ route('admin.cupon.update') }}" method="post">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="code" value="{{ $cats->code}}">
                                </div>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="date" class="form-control" name="active_from" value="{{ $cats->active_from }}">
                                </div>

                                <div class="form-group col-lg-6">
                                    <label>Active To</label>
                                    <input type="date" class="form-control" name="active_to" value="{{ $cats->active_to }}">
                                </div>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <select class="form-control select2" name="discount_type">
                                        <option>Select</option>
                                        <option value="0" {{ $cats->discount_type == 0 ? 'selected':'' }}>Fixed</option>
                                        <option value="1" {{ $cats->discount_type == 1 ? 'selected':'' }}>Percentage</option>
                                    </select>
                                </div>

                                <div class="form-group col-lg-6">
                                    <label>Discount Amount</label>
                                    <input type="number" class="form-control" name="discount_amount" value="{{ $cats->discount_amount }}">
                                </div>
