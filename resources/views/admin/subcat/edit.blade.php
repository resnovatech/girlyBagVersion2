...
<div class="page-content">
                        ...
                        <div class="col-sm-6">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active">Update Product Child Category</li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form class="custom-validation" action="{{ route('admin.subcategory.update') }}" method="post">
                            @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                ...
                <option value="{{ $newcat->category_slug }}" {{ $cats->category_slug == $newcat->category_slug ? 'selected':'' }}>{{ $newcat->category_name }}</option>
               @endforeach
                                                    </select>
                                                </div>
                                ...
                                <input type="text" class="form-control" id="name" value="{{ $cats->subcategory_name }}" name="subcategory_name" placeholder="Enter Name">
