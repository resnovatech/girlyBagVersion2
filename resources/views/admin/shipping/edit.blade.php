                        ...
                        <div class="col-sm-6">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active">Update Shipping Area Name</li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form class="custom-validation" action="{{ route('admin.shipping.update') }}" method="post">
                            @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group ">
                                                    <label>Shipping Area Name:</label>
                                                    <input type="text" class="form-control" name="area" value="{{ $cats->area }}"/>
