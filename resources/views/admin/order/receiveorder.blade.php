            ...
            <div class="col-sm-6">
                <div class="page-title-box">
                    ...
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active">Manage Receive Order</li>
                    </ol>
                </div>
            </div>
...
Delivared
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            onclick="window.location.href='{{ route('admin.receive_order.view',$all_new->Newt) }}'"><i class="fa fa-eye"></i></button>
