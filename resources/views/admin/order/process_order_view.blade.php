...
<div class="card-footer">
    <div class="row">
      @if($order->status == 0 || $order->status == 1 || $order->status == 2 || $order->status == 4)
      <div class="col-md-6">
       <form action="{{ route('admin.order.update') }}" id="form_validation" method="POST">
        @csrf
        <div class="form-group">
         <input type="hidden" class="form-control" name="id" value="{{ $order->Newt }}" id="exampleInputEmail1" placeholder="Enter Name">
