                        ...
                        <div class="col-sm-6">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active">Product Parent Category</li>
                                </ol>
                            </div>
                        </div>
                                      ...
                                      @endif
                                                ...
                                                <td>
                                                    ...
                                                    @if (Auth::guard('admin')->user()->can('category.edit'))
                                                        <a type="button" href="{{ route('admin.category.edit', $category->id) }}" class="btn btn-primary waves-light waves-effect"><i class="fas fa-pencil-alt"></i></a>
                                                        @endif
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title mt-0" id="myLargeModalLabel">Add New Parent Category</h5>
