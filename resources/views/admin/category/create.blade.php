        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.category') }}">All Category</a></li>
                    ...
                    <div class="body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="name" name="category_name" placeholder="Enter Name">
                            </div>
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="email">Icon</label>
                                <input type="file" class="form-control" id="email" name="icon" placeholder="Enter Icon">
                            </div>
                        </div>
