...
<div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form class="custom-validation" action="{{ route('admin.brand.update') }}" method="post">
                            @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                    ...
                    <option value="{{ $category->category_slug }}" {{ $cats->cat_id == $category->category_slug ? 'selected':'' }}>{{ $category->category_name }}</option>
                    @endforeach
