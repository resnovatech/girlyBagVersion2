                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="page-title-box">
                                <h4 class="font-size-18">Product Brand</h4>
                            ...
                            <div class="float-right d-none d-md-block">
                                ...
                                @if (Auth::guard('admin')->user()->can('brand.create'))
                                    <button class="btn btn-primary dropdown-toggle waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-lg" type="button">
                                        <i class="far fa-calendar-plus  mr-2"></i> Add New Brand
                                    </button>
                                    @endif
                                </div>
                            </div>
                                      ...
                                      @endif
                                                ...
                                                <td>
                                                    ...
                                                    @if (Auth::guard('admin')->user()->can('brand.edit'))
                                                        <a type="button" href="{{ route('admin.brand.edit', $category->id) }}" class="btn btn-primary waves-light waves-effect"><i class="fas fa-pencil-alt"></i></a>
                                                        @endif
...
@endif
                                                        <form id="delete-form-{{ $category->id }}" action="{{ route('admin.brand.destroy',$category->id) }}" method="POST" style="display: none;">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title mt-0" id="myLargeModalLabel">Add New Brand</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>
                        <div class="modal-body">
                            <form class="custom-validation" action="{{ route('admin.brand.store') }}" method="post">
                            @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                                    ...
                                    <select name="cat_id" id="roles" class="form-control">
