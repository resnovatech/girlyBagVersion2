...
<div class="page-content">
    <div class="holder mt-0 py-3 py-sm-5 py-md-10 bg-cover lazyload" data-bgset="{{ asset('/') }}public/front/images/pages/about-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-11 col-md-9 col-xl-9">
                    <div class="page-title-bg py-md-3 py-xl-6">
                        <h1>ABOUT US</h1>
                        <p class="d-none d-md-block">The Girly Bag is focus to provide the best health and wellbeing care to every girl, woman, and mother..</p>
                        <p>We’re your healthcare and hygiene companion. We have combined AI with health for making your life a bit easier. We’ll help you to log, track, and analyze your menstrual cycles and activities, and we’ll remind you right before your next period. </p>
                        <p class="d-none d-md-block"><i><b>Our support is available 9.00 am – 12.00 pm (Saturday – Friday).<br>
                    ...
                    <div class="testimonials-carousel-wrap">
                        ...
                        <div class="testimonials-carousel js-testimonials-carousel" data-slick='{"slidesToShow": 1, "responsive": [{"breakpoint": 992,"settings": {"slidesToShow": 1 }},{"breakpoint": 480,"settings": {"slidesToShow": 1 }}]}'>
                            <div class="testimonials-item">
                                <div class="row vert-margin">
                                    <div class="col-sm-5 testimonials-item-photo text-center">
                                        ...
                                        data-src="{{ asset('/') }}public/front/images/review-author.webp" alt="" class="rounded-circle lazyload fade-up">
                                    </div>
                            ...
                            <div class="testimonials-item">
                                <div class="row vert-margin">
                                    <div class="col-sm-5 testimonials-item-photo text-center">
                                        <img src="data:{{ asset('/') }}public/front/image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{ asset('/') }}public/front/images/review-author-02.webp" alt="" class="rounded-circle lazyload fade-up">
                                    </div>
                                    <div class="col-sm-13 testimonials-item-text">
