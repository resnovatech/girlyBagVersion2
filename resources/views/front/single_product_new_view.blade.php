                        ...
                        <div class="prd-block_main-image">
                            <div class="prd-block_main-image-holder" id="prdMainImage">
                                <div class="product-main-carousel js-product-main-carousel" data-zoom-position="inner">
                                    ...
                                    <div data-value="Beige"><span class="prd-img"><img
                                                ...
                                                class="lazyload fade-up " alt="" </span> </div> @endforeach </div>
                                                </div> </div> <div class="product-previews-wrapper">
                                    ...
                                    <div class="prd-block_info-top prd-block_info_item order-0 order-md-2">
                                        <div class="prd-block_price prd-block_price--style2">
                                            ...
                                            <div class="prd-block_price--actual">৳
                                                {{ $product_single_view->sell_price }}</div>

                                        </div>
                                    </div>
                                    <div class="prd-block_description prd-block_info_item ">
                                        <h3>Short description</h3>
                                        <p>{!! $product_single_view->short_des !!}</p>
                                        <!-- <div class="mt-1"></div>
                            <div class="row vert-margin-less">
                                ...
                                <div class="col-sm">
                                    ...
                                    <div class="prd-block_info_item prd-block_info-when-arrives d-none"
                                        data-when-arrives>
                                    ...
                                    <div class="prd-block_info-box prd-block_info_item">
                                        <div class="two-column">
                                            ...
                                            <p>Collection: <span> <a href="collections.html" data-toggle="tooltip"
                                                        data-placement="top"
                                                        data-original-title="View all">{{ $category_name }}</a></span>
                                            </p>
                                            <p>Reward-Point: <span
                                                    data-sku="">{{ $product_single_view->reward_point_product_count }}</span>
                                            </p>
                                    ...
                                    <div class="order-0 order-md-100">
                                        ...
                                        <div class="prd-block_actions prd-block_actions--wishlist">
                                            <div class="prd-block_qty">
                                                ...
                                                <div class="qty qty-changer productnew">
                                                    ...
                                                    <input type="number" class="qty-input" id="number" name="quantity"
                                                        value="1" data-min="1" data-max="1000">
                                                    <input type="hidden" value="{{ $product_single_view->id }}"
                                                        class="product_id" id="id2" name="id">
                                            ...
                                            "{{asset('/')}}{{'public/upload/'.$stock1}}", "aspect_ratio ": "0.78"}'>
                                                ...
                                                @if (Auth::guest())
                                                <button class="btn btn--add-to-cart add-to-cart-btnnewLogin"  >
                                                     Buy Now
                                                </button>
                                                @else
                                                <button class="btn btn--add-to-cart add-to-cart-btnnewRegister"  >
                                                    Buy Now
                                               </button>
                                        ...
                                        <div class="prd-block_agreement prd-block_info_item order-0 order-md-100 text-right"
                                            ...
                                            <label for="agreementCheckboxProductPage"><a href="#" data-fancybox
                                                    class="modal-info-link" data-src="#agreementInfo">I agree to the
                                    ...
                                    <div class="prd-block_info_item">
                                        <ul class="prd-block_links list-unstyled">
                                            <li><i class="icon-delivery-1"></i><a href="#" data-fancybox
                                                    class="modal-info-link" data-src="#deliveryInfo">Delivery and
                                                    Return</a>
                                            </li>
                                        ...
                                        <div id="deliveryInfo" style="display: none;"
                                            ...
                                            <p>Foxic is proud to offer an exceptional international parcel shipping
                                                service. It is
                                                straightforward and very easy to organise international parcel shipping.
                                                Our
                                                customer service team works around the clock to make sure that you
                                                receive high
                                                quality courier service from start to finish.</p>
                                            <p>Sending a parcel with us is simple. To start the process you will first
                                                need to get a
                                                quote using our free online quotation service. From this, you’ll be able
                                                to navigate
                                                through the online form to book a collection date for your parcel,
                                                selecting a
                                        ...
                                        <div id="contactModal" style="display: none;"
                                            ...
                                            <form method="post" action="#" id="contactForm" class="contact-form">
                                                ...
                                                <div class="form-group">
                                                    <textarea class="form-control textarea--height-170"
                                                        name="contact[body]" placeholder="Message"
                                    ...
                                    <div class="prd-block_info_item">
                                        <img class="img-responsive lazyload d-none d-sm-block"
                                            ...
                                            data-src="{{ asset('/') }}public/front/images/payment/safecheckout.webp"
                                            alt="">
                                        <img class="img-responsive lazyload d-sm-none"
                                            src="data:{{ asset('/') }}public/front/image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                            data-src="{{ asset('/') }}public/front/images/payment/safecheckout-m.webp"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="holder mt-3 mt-md-5">
                    <div class="container">
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a href="#Tab1" class="nav-link js-tabcollapse-panel-heading active" data-toggle="tab" data-parent="">Description
                            ...
                            <div class="prd prd--style2 prd-labels--max prd-labels-shadow ">
                                <div class="prd-inside">
                                    <div class="prd-img-area">
                                        <a href="{{route('product_single_view',$newRand->product_slug)}}"
                                        ...
                                        <div class="prd-circle-labels">
                                            ...
                                            <a class="circle-label-qview view-product prd-hide-mobile"
                                                data-productid="{{$newRand->id}}"><i class="icon-eye"></i><span>QUICK
                                                    VIEW</span></a>
                                        </div>
                                    </div>
                                    <div class="prd-info">
                                        <div class="prd-info-wrap">
                                            ...
                                            <h2 class="prd-title"><a
                                                    href="{{route('product_single_view',$newRand->product_slug)}}">{{ $newRand->product_name }}</a>
                                            </h2>
                                            ...
                                            <div class="prd-action">
                                                <div class="prd-action-left">
                                                    ...
                                                    <button id="footer_cart" class="btn addtocart js-prd-addtocart"
                                                        data-product-id="{{ $newRand->id }}"
                                                        data-product='{"name": "{{ $newRand->product_name }}",
    "path":
                                        ...
                                        <div class="prd-hovers">
                                            <div class="prd-circle-labels">
                                                ...
                                                <div class="prd-hide-mobile"><a class="circle-label-qview view-product"
                                            ...
                                            <div class="prd-action">
                                                <div class="prd-action-left product_data">
                                                    ...
                                                    <input type="hidden" value="{{ $newRand->id }}" class="product_id"
                                                        name="id">

                                                    <button id="footer_cart"
                                                        class="btn add-to-cart-btn js-prd-addtocart"
                                                        data-product-id="{{ $newRand->id }}"
                                                        data-product='{"name": "{{ $newRand->product_name }}", "path":
                                                   "{{asset('/')}}{{'public/upload/'.$stock}}", "url":"{{ url('/cart') }}", "aspect_ratio":0.778}'>
                                                        Add To Cart
                                                    </button>
            ...
            <script>
                $(document).ready(function () {
                    ...
                    $('.add-to-cart-btnnewLogin').click(function (e) {
                        e.preventDefault();
                        ...
                        $.ajax({
                         ...
                         window.location.href="{{ route('customer_dashoard.login') }}";
                  ...
                  $('.add-to-cart-btnnewRegister').click(function (e) {
                        e.preventDefault();
